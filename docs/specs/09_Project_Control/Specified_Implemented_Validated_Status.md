# Advokat AI — Specified Implemented Validated Status
...
## Specified / Implemented / Validated tracking

| Area | Specified | Implemented | Validated | Notes |
|---|---|---|---|---|
| Case model | yes | no | no | Build PR 2-4 |
| RBAC | yes | no | no | Build PR 3 |
| Audit | yes | no | no | Build PR 2-3 |
| Document upload | yes | no | no | Build PR 5 |
| OCR pipeline | yes | no | no | Build PR 6 |
| Source graph | yes | no | no | Build PR 7 |
| Assistant | yes | no | no | Build PR 8 |
| Drafts | yes | no | no | Build PR 9 |
| Export gate | yes | no | no | Build PR 10 |
| Compliance | partial | no | no | Owner decisions needed |
