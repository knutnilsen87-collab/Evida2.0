# Advokat AI — Stakeholder Approvals
...
| Approval | Pilot Candidate | Official Release |
|---|---|---|
| Product owner | required | required |
| Legal responsible | required | required |
| Security responsible | required | required |
| Compliance/privacy responsible | required | required |
| Engineering lead | required | required |
| QA lead | required | required |
| Operations owner | recommended | required |
| Pilot customer representative | required | recommended |
