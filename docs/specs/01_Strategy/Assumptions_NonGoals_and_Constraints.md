# Advokat AI — Assumptions NonGoals and Constraints
...
- Product is Norwegian-first.
- Pilot uses real legal documents under signed pilot terms.
- Users are professionals, not consumers.
- Legal source integrations may start manual/verified before API integrations.
- First version is desktop/laptop-first.
- External sharing is tightly controlled.
- AI provider must support no-training/no-retention contractual posture or be replaceable.
- Human approval is mandatory for export and external sharing.

## Constraints

- Must be GDPR-compliant.
- Must support confidential legal material.
- Must be source-grounded.
- Must be auditable.
- Must avoid mental overload.
- Must be explainable to non-technical legal users.

## Non-goals

- Consumer legal advice.
- Fully autonomous legal decision-making.
- Unbounded internet browsing by agents.
- Unapproved client portal in pilot.
- Mobile-native first release.
