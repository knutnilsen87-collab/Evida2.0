# Advokat AI — Release Gate Profile
...
## Pilot Candidate release checklist

- [ ] Pilot agreement approved.
- [ ] Data processing terms approved.
- [ ] Tenant isolation tested.
- [ ] Auth/MFA configured.
- [ ] Document upload tested with real pilot samples.
- [ ] OCR quality visible.
- [ ] Source graph works.
- [ ] Draft source coverage works.
- [ ] Export gate blocks correctly.
- [ ] Audit trail complete.
- [ ] Assistant guided mode works.
- [ ] Backup configured.
