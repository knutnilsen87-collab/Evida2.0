# Advokat AI — Project Type Selection
...
- Enterprise/security-sensitive application
- Backend API service
- Data/ML-adjacent system
- Compliance-heavy product

Not active for initial build:
- Native mobile app
- Marketplace
- Browser extension
- Desktop plugin
- Public self-serve consumer app
