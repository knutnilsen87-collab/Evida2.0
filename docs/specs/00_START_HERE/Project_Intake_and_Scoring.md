# Advokat AI — Project Intake and Scoring
...
|---|---:|---|
| Legal/compliance sensitivity | 5/5 | Real legal documents and legal work product |
| Privacy sensitivity | 5/5 | Personal data, confidential communications, potentially special category data |
| Security sensitivity | 5/5 | Case data, client secrets, privileged material |
| AI risk | 5/5 | Hallucination/source errors can cause serious harm |
| UX complexity | 5/5 | Must hide complexity without hiding control |
| Technical complexity | 5/5 | OCR, source graph, agents, document processing, audit, permissions |
| Operational complexity | 4/5 | Incident response, retention, audit export, backups |
| Recommended governance | Highest rigor | Pilot only under controlled legal/compliance agreement |

## Required project controls

- Formal source-of-truth hierarchy.
- Canonical domain model.
- Approval gates.
- Security review.
- DPIA before Official Release.
