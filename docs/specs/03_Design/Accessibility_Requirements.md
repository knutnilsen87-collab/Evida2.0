# Advokat AI — Accessibility Requirements
...
- Screen reader labels for controls and status chips.
- No color-only meaning.
- Sufficient contrast.
- Reduced motion support.
- Assistant guidance accessible as text, not only visual highlight.
- Error messages clear and actionable.
- Document viewer supports text extraction panel for screen readers where possible.
