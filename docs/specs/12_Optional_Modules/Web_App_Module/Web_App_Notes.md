...
- Desktop-first legal workspace.
- Responsive enough for tablet/mobile review.
- Persistent assistant panel.
- Document viewer and draft editor are primary high-density surfaces.
- Must support keyboard navigation.
- Must avoid visual overload.
