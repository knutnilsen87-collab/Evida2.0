...
Native mobile app is not active for Pilot Candidate.

Mobile-responsive web requirements:
- Read case overview.
- Check status.
- Ask assistant.
- Review warnings.
- Do not optimize complex drafting/document review for mobile first.
