...
|---|---|---|
| P0 | Cross-tenant data exposure, unauthorized export, data loss | Immediate shutdown/containment |
| P1 | Critical source/audit failure, auth bypass | Hotfix, notify stakeholders |
| P2 | OCR outage, assistant degradation | Mitigate, queue retry |
| P3 | UX bug, non-critical warning issue | Normal backlog |

## Incident steps

1. Contain.
2. Preserve audit/log evidence.
3. Identify affected tenants/cases/documents.
