# Advokat AI — Observability Minimum Contract
...
- OCR duration/failure
- agent run duration/failure
- export gate pass/fail
...
- export gate unexpected pass/fail anomaly
- audit write failure
- object storage failure
- LLM/OCR provider failure
