# Advokat AI — Backlog Epics User Stories
...
- Guided modes.
- Falloff detection events.
- Assistant safety rules.

### Epic 5 — Legal workspace
- Timeline.
- Evidence map.
- Argument board.
- Risk register.
