...
1. Auth/tenant/case model before documents.
2. Documents before OCR.
3. OCR/pages/chunks before SourceRef.
4. SourceRef before FactClaim verification.
5. FactClaim before timeline/evidence/arguments.
6. Drafts before export gate.
7. Audit must be available before critical actions.
8. Assistant can start early but must gain deep context as domain models become available.
9. Export requires source, privacy, approval and audit dependencies.
