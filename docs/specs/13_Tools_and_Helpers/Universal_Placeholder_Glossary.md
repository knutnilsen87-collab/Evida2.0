# Advokat AI — Universal Placeholder Glossary
...
This module is inactive for Pilot Candidate unless explicitly reactivated by product owner.

Do not implement this before core Pilot Candidate path is complete.
