...
### Senior lawyer
Needs speed, source control, reliable overview and export confidence. Hates toy AI and hidden uncertainty.

### Junior associate
Needs guided legal workflow, explanations, structure and confidence that they are not missing key steps.

### Legal operations/admin
Needs access control, audit, repeatability, case organization and compliance visibility.

### Compliance/security reviewer
Needs evidence that confidential legal documents are isolated, auditable, encrypted and not used unsafely by AI providers.

### External collaborator/client
Future/controlled role. Needs narrow access and simple review flows. Not active by default in Pilot Candidate.
