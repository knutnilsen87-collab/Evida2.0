...
Tone: calm, professional, precise, encouraging.

Avoid:
- “AI magic”
- excessive legalese when explaining product use
- blaming the user
...
### Export blocked
“Eksport er stoppet fordi dokumentet ikke er klart ennå. 3 avsnitt mangler kilde, og 1 vedlegg er ikke ferdig kontrollert.”
...
### Assistant welcome
“Jeg kan hjelpe deg med både saken og selve programmet. Spør på din egen måte, for eksempel: ‘Hva gjør jeg nå?’ eller ‘Hvorfor er dette blokkert?’”

### Missing source
“Denne påstanden kan ikke brukes i endelig eksport før den er koblet til en kilde.”
